...
<head>
  ...
  <title>Danışman Akademi Portal Yönetim Paneli </title>
  ...
  <!-- Animate.css -->
  <link href="js/vendors/animate.css/animate.min.css" rel="stylesheet">
      ...
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form action="islem.php" method="POST">
            ...
            <div>
              <input type="text" name="k_adi" class="form-control" placeholder="Kullanıcı Adınız (Mail)" required="" />
            </div>
            <div>
              <input type="password" name="k_sifre" class="form-control" placeholder="Şifreniz" required="" />
            </div>
            <div>
            ...
            <div class="separator">
             ...
             ?>
              ...
              <div>
                <h1>Danışman Akademi</h1>
                <p>©2019 Danışman Akademi</p>
              </div>
            </div>
          </form>
